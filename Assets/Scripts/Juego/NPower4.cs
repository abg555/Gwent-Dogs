...
public class NPower4 : MonoBehaviour
{
    ...
    public void NPowerChau()
    {
        ...
        foreach (Transform child in as2.transform)
        {
            ...
            if (cardView != null && cardView.cardName == targetCardName && cardView.cardNumber != 45)
            {
            ...
            else if (cardView != null && cardView.cardNumber == 45)
            {
