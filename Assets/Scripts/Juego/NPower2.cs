...
public class NPower2 : MonoBehaviour
{
    ...
    public void NPowerChau()
    {
        ...
        foreach (Transform child in as1.transform)
        {
            ...
            if (cardView != null && cardView.cardName == targetCardName && cardView.cardNumber != 22)
            {
            ...
            else if (cardView != null && cardView.cardNumber == 22)
            {
