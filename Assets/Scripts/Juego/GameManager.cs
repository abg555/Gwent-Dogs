...
public class GameManager : MonoBehaviour
{
    ...
    void Card()
    {
        ...
        if (!cards8 && childCount == 2 && childCount2 == 7)
        {
            ...
            foreach (Transform child in cardzone.transform)
            {
                ...
                deckButton.gameObjects.Add(card);

                for (var i = 0; i < 1; i++)
                {
                    int randomIndex = Random.Range(0, deckButton.cards.Count);
                    GameObject playerCard = Instantiate(deckButton.gameObjects[randomIndex], new Vector3(0, 0, 0), Quaternion.identity);
    ...
    void Card2()
    {
        ...
        if (!cards9 && childCount == 2 && childCount2 == 7)
        {
            ...
            {
                GameObject card = Instantiate(child.gameObject, new Vector3(0, 0, 0), Quaternion.identity);
                deckButton2.gameObjects2.Add(card);

                for (var i = 0; i < 1; i++)
                {
                    int randomIndex = Random.Range(0, deckButton2.cards2.Count);
                    GameObject playerCard = Instantiate(deckButton2.gameObjects2[randomIndex], new Vector3(0, 0, 0), Quaternion.identity);
    ...
    public int TriggerPlayer()
    {
        ...
        {
            Debug.Log("El jugador");
            return 0;
        }
        else
        {
            Debug.Log("El enemigo");
            return 1;
