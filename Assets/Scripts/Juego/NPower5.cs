...
public class NPower5 : MonoBehaviour
{
    ...
    public void NPowerChau()
    {
        ...
        foreach (Transform child in as2.transform)
        {
            ...
            if (cardView != null && cardView.cardName == targetCardName && cardView.cardNumber != 46)
            {
            ...
            else if (cardView != null && cardView.cardNumber == 46)
            {
