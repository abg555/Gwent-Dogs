...
//             else
//             {
//                 throw new Exception($"Valor no válido para Single: {token.lexeme}. Se esperaba 'true' o 'false'.");
//             }
//         }
//     }
...
//     public Activation(Variable targets, Variable context, StatementBlock block)
//     {
//         Targets = targets;
//         Context = context;
//         Block = block;
...
//     public Expression condition;
//     public StatementBlock body;
//     public ForStatement(Expression condition, StatementBlock body)
//     {
//         this.condition = condition;
//         this.body = body;
//     }
